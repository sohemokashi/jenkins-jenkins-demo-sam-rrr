...
repository="docker-registry.mtk8s.io/voyagers/jenkins-jenkins-demo-sam-rrr"
RepositoryName="jenkins-jenkins-demo-sam-rrr"
...
ENTITY_NAME = "jenkins-jenkins-demo-sam-rrr"
